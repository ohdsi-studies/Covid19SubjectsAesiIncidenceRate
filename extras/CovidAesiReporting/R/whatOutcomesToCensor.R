...
#'
#'
whatOutcomesToCensor <- function(dataFolder, censorshipFile,censoredResults=0,negativeControls=0){
  ...
  if(negativeControls){
    colnames(censorshipDf) <- c('DB','562','563', '565', '566', 'DIV', '598','597','596','595','594','593','592','591','590','589','588','587','586','585','584','583','582','581','580','579')
  }
