...
baseCohortJson <- SqlRender::readSql(system.file("cohorts", "Cohort562-COVID19_lab.json", package = "Covid19SubjectsAesiIncidenceRate"))
...
baseCohortJson <- SqlRender::readSql(system.file("cohorts", "Cohort563-COVID19_labDx.json", package = "Covid19SubjectsAesiIncidenceRate"))
baseCohort <- RJSONIO::fromJSON(baseCohortJson)
